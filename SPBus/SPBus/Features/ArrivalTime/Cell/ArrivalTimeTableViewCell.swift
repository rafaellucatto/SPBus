...
final class ArrivalTimeTableViewCell: UITableViewCell {

    static let identifier: String = "ArrivalTimeTableViewCell"
    ...
    func configure(with viewModel: ArrivalTimeTableViewCellViewModel) {
        rowNumberLabel.text = viewModel.rowNumberLabel
        lineWiseLabel.text = viewModel.lineWiseLabel
    }
